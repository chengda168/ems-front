  ...
  <div class="siemensLayoutCon">
    <div class="siemensLayoutSearchBox" :class="{ collspaseForm: collapse }">
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" class="fullBtn" @click="onSearch"
    ...
    <div class="siemensLayoutResultBox whiteBg">
      <div
        class="siemensLayoutResultTitle siemensLayoutResultTitleNoBtn flexBetween"
      >
        <span>查询结果</span>
      </div>
      <div class="siemensLayoutResultCon">
        ...
        >
          ...
          <el-table-column align="center" prop="modules" label="模 块">
          </el-table-column>
          <el-table-column align="center" prop="user_name" label="操作人">
          </el-table-column>
          <el-table-column align="center" prop="create_date" label="操作时间">
          </el-table-column>
          <el-table-column align="center" prop="access_type" label="访问入口">
            <template slot-scope="scope">
              {{ scope.row.access_type == 1 ? "WEB端" : "小程序" }}
            </template>
          </el-table-column>
          <el-table-column align="center" prop="access_ip" label="IP地址">
          </el-table-column>
          <el-table-column
            align="left"
            :width="maxWidth"
      ...
      content: [
        {
          ...
          describe:
            '告警内容：{"taskDesc":"指定班组","taskName":"维修"}, 接收用户：13819183200,13905813777,18019025732,18621280717,siemens， 返回值：{"RequestId":"AA9A26BA-CB4D-4523-9977-8105487E3CED","Message":"siemens invalid mobile number","Code":"isv.MOBILE_NUMBER_ILLEGAL"}',
        },
        {
          operate_type: "新建",
          id: 1,
          ...
          access_ip: "123456@163.com",
          describe:
            '告警内容：{"taskDesc":"指定班组","taskName":"维修"}, 接收用户：13819183200,13905813777,18019025732,18621280717,siemens',
        },
        {
          operate_type: "新建",
          id: 2,
        ...
        },
        {
          ...
          access_ip: "123456@163.com",
          describe:
            '返回值：{"RequestId":"AA9A26BA-CB4D-4523-9977-8105487E3CED","Message":"siemens invalid mobile number","Code":"isv.MOBILE_NUMBER_ILLEGAL"}',
        },
        {
          operate_type: "新建",
          id: 4,
