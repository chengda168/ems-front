    ...
    <div class="siemensHomeNav flexStartBetween">
      ...
      <div class="siemensHomeOperate flexCenter">
        ...
        <div style="position: relative;">
          <span class="siemensHomeLang flexEnd" @click.stop="isShowLang = !isShowLang">{{langText}}<i class="iconfont icon-jiantou"></i></span>
          <ul class="langItemBox" v-if="isShowLang">
            <li class="langItems" v-for="(item,index) in langList" :key="index" :class="{ langActive: activeIndex == item }" 
    ...
    <div class="siemensHomeCon flexBox">
        <div class="siemensHomeInfo">
          <div class="siemensHomeInfoBtn flexColumnCenter">
            <router-link to="" class="siemensHomeInfoBtnBox siemensHomeInfoPer flexCenter" @click.native.stop="isShowHead = !isShowHead"><i class="iconfont icon-iconfontgerenzhongxin"></i></router-link>
            <router-link to="/custom" class="siemensHomeInfoBtnBox siemensHomeInfoSetting flexCenter"><i class="iconfont icon-shezhi"></i></router-link>
...
@media screen and (min-width: 1665px) {
  ...
  .siemensHomeMap{
    ...
    background: linear-gradient(134deg, rgba(1,79,100,.85) 0%, rgba(0,80,108,.85) 100%);
  ...
  .siemensHomeSwiper /deep/ .el-carousel__indicator--horizontal:not(:last-child){
    margin-right: 5px;
  }
