<template>
  <div class="bgLogin">
    <div class="lim">
      ...
      <div class="footLogin">西门子中国&nbsp;&nbsp;© 西门子（中国）有限公司 1996 – 2021Legal navigation&nbsp;&nbsp;&nbsp;&nbsp;企业信息&nbsp;&nbsp;&nbsp;&nbsp;隐私政策&nbsp;&nbsp;&nbsp;&nbsp;Cookie政策&nbsp;&nbsp;&nbsp;&nbsp;使用条款&nbsp;&nbsp;&nbsp;&nbsp;京ICP备06054295号&nbsp;&nbsp;&nbsp;&nbsp;京公网安备 11010502040638号</div>
    </div>
  </div>
</template>
<script>
  ...
  data() {
    return {
      ...
      rule:{
        ...
        vcode: [
          { required: true, message: '验证码错误，请重新输入', trigger: 'blur' }
        ],
      }
    }
  },
